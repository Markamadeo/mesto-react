  ...
  return (
    ...
    >
      <figure className="form__container form__container_type_foto-viewer">
        ...
        ></button>
        <img src={props.card.card.link} alt={props.card.name} className="form__foto-viewer-img" />  
        <figcaption className="form__foto-viewer-description">{props.card.name}</figcaption>
      </figure>
    </section>
  );
}
